...
public class loschen extends JFrame {
    ...
    Login lq = new Login();
    LoschenLogik LoschenLogik = new LoschenLogik();
    public loschen() {
        panel1 = new JPanel();
        ...
        loginButton = new JButton("Löschen");
        ...
        loginButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                LoschenLogik.setLoschenEmail(emailInput);
                LoschenLogik.setLoschenPassword(passwordInput);
                LoschenLogik.userLoeschen();
